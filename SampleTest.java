...
public class SampleTest {
	...
	public void testBFS1() {
		ArrayList<String> res = Main.getWordLadderBFS("heArt", "pArTs");
	...
	@Test
	public void testCaseDFS() {
		ArrayList<String> res = Main.getWordLadderDFS("heArt", "parTs");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	/** No Word Ladder **/
	@Test()
	public void testWrongLen() {
		ArrayList<String> res = Main.getWordLadderBFS("cell", "temp");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	@Test()
	public void testSecondWrong() {
		ArrayList<String> res = Main.getWordLadderDFS("cells", "temp");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	@Test()
	public void testRungNum() {
		ArrayList<String> res = Main.getWordLadderBFS("HELLO", "CELLS");
		int rung = Main.rungNum;
		assertTrue(res.size() == rung);
	}
	...
	public void testBFS6() {
		ArrayList<String> res = Main.getWordLadderBFS("stone", "karim");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	public void testDFS6() {
		ArrayList<String> res = Main.getWordLadderDFS("stone", "karim");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	public void testDFS3() {
		ArrayList<String> res = Main.getWordLadderDFS("smoke", "hakus");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	@Test(timeout = 30000)
	public void testPrintLadder1() {
		ArrayList<String> res = Main.getWordLadderBFS("smoke", "hakus");
		outContent.reset();
		Main.printLadder(res);
		if(res!=null){
			HashSet<String> set = new HashSet<String>(res);
			...
			String str = outContent.toString().replace("\n", "").replace(".", "").trim();
			assertEquals("no word ladder can be found between smoke and hakus", str);
		}
	}
	@Test(timeout = 30000)
	public void testBFS4() {
		ArrayList<String> res = Main.getWordLadderBFS("eaten", "beats");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
	...
	public void testDFS4() {
		ArrayList<String> res = Main.getWordLadderDFS("eaten", "beats");
		if (res != null) {
			HashSet<String> set = new HashSet<String>(res);
			assertEquals(set.size(), res.size());
		}
